...
<div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="text-center" style="width: 100%; max-width: 480px; padding: 1rem;">
        ...
        <img src="{{ asset('images/Tatui.png') }}" alt="Tatuí" style="width:100%;max-width:480px;object-fit:contain;margin-bottom:.75rem;display:block;margin-left:auto;margin-right:auto;">
