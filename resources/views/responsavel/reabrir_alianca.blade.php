...
@section('page-title', 'Reabrir Aliança')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2>Reabrir Votação — Realidade de Aliança</h2>
...
<div class="card border-warning" style="max-width: 500px;">
    <div class="card-body">
        <div class="alert alert-warning mb-4">
            ...
            Esta ação reabre a votação aliança de <strong>{{ $eleicaoCidade->cidade->nome }}</strong> para receber novos votos.
        ...
        <form method="POST" action="{{ route('responsavel.alianca.confirmarReabrir', $eleicaoCidade) }}">
            @csrf
            ...
            <button type="submit" class="btn btn-warning w-100 fw-semibold">
                <i class="bi bi-arrow-counterclockwise me-2"></i>Confirmar Reabertura — Aliança {{ $eleicaoCidade->cidade->nome }}
            </button>
        </form>
    </div>
</div>
