...
{{-- ── Sidebar ─────────────────────────────────────────────── --}}
<aside class="sidebar">
    <a href="{{ route('responsavel.index') }}" class="sidebar-brand">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div>
                ...
                <div class="sidebar-user-role">Responsável</div>
            </div>
        </div>
    </div>
</aside>
...
<div class="main-wrapper">
    ...
    <header class="topnav">
        <span class="topnav-title d-none d-md-block">@yield('page-title', 'Responsável')</span>
